/******************************
 Cjhdevact Github 主页 - Win10-UI 模块
 名称：win10.js
 作者：Yuri2,CJH
 历史：
...
window.Win10 = {
    ...
    _init:function () {
        ...
        $("#win10-btn-browser").click(function () {
            ...
            layer.prompt({
                ...
                layer.close(i);
                layer.msg(Win10.lang('请稍候...','Hold on please...'),{time:1500},function () {
                    Win10.openUrl(value,'<img class=\'icon\' src=\'./Assets/icon/edge.png\'/>' + value);
                });
            });
        });
        setInterval(function () {
        ...
        Win10.setContextMenu('#win10>.desktop',[
            ['<i class="fa fa-fw fa-star"></i> 收藏本页',function () {
                ...
                if (ua.indexOf("360se") > -1) {
                    layer.alert(Win10.lang('你的的浏览器不支持此操作,请按 Ctrl+D 手动收藏。','Your browser does not support, please press Ctrl+D to manual collection.'));
                }
    ...
    newMsg: function (title, content,handle_click) {
	    ...
	    layer.tips(title, '#win10_btn_command', {
            //tips: [1, '#3c6a4a'],
			tips: [1, '#323232'],
            time: 3000
        });
    ...
    exit:function () {
	    ...
	    layer.confirm(Win10.lang('确认要关闭吗?','Are you sure you want to close this page?'), {icon: 3,title:Win10.lang('提示','Prompt')}, function(index){
            document.body.onbeforeunload = function(){};
            window.location.href="about:blank";
            window.close();
            layer.close(index);
            layer.alert(Win10.lang('出现问题。','There be a problem.'), {
                skin: 'layui-layer-lan'
                ,closeBtn: 0
            });
        });
    ...
    aboutUs: function() {
        ...
        //});
            ...
            //closeBtn: 0,
            anim: 2,
            skin: 'layui-layer-lan', //def title color 4476A7
            title: '关于 Cjhdevact 主页',
            shadeClose: true, //开启遮罩关闭
            area: ['320px', '270px'], //宽高
            content: '<div style="padding: 10px;font-size: 12px">' +
			'<img style="width: 30px;height: 30px;margin: 4px auto;display: block" src="./Assets/logo.png"><div style="color: #0000ff;text-align: center;font-size: 20px">Cjhdevact 主页</div>' +
            '<p><center>——————————————————————</center></p>' +
	...
	UseDark:function () {
		    //window.open('https://cjhdevact.github.io/index.html')
            //document.body.onbeforeunload = function(){};
